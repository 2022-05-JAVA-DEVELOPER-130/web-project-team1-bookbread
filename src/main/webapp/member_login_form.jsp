	...
	<!-- include_common_top.jsp end-->
							...
							<form name="f" method="post">
								<table style = "margin-left: auto; margin-right: auto;" border="0" cellpadding="0" cellspacing="1"
									bgcolor="BBBBBB">
									<tr>
										<td width=100 align="center" bgcolor="#f4bf6f" height="22">아이디</td>
										<td width=190 align="center" bgcolor="#fff"
									...
									<tr>
										<td width=100 align="center" bgcolor="#f4bf6f" height="22">비밀번호</td>
										<td width=190 align="center" bgcolor="#fff"
							...
							<table style = "margin-left: auto; margin-right: auto;" border="0" cellpadding="0" cellspacing="1">
								<tr>
									<td align=center>
										...
										<input type="button" value="회원가입" onClick="MemberCreate()"></td>
								</tr>
							</table>
	<!-- jQuery Library -->
	<script
