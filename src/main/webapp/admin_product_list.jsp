...
<body>
	...
	<table style="margin: auto" border=0 width=80% height=400 align=center>
		<tr valign=middle>
			<td width=5% align=center class=t1><font size=2 color=#000000><b>도서 번호</b></font></td>
			<td width=10% align=center class=t1><font size=2 color=#000000><b>도서 이름</b></font></td>
			<td width=5% align=center class=t1><font size=2 color=#000000><b>저 자</b></font></td>
			...
			<td width=5% align=center class=t1><font size=2 color=#000000><b>도서 가격</b></font></td>
			<td width=45% align=center class=t1><font size=2 color=#000000><b>도서 소개</b></font></td>
			<td width=5% align=center class=t1><font size=2 color=#000000><b>분류 번호</b></font></td>
			<td width=5% align=center class=t1><font size=2 color=#000000><b>도서 종류</b></font></td>
			<td width=5% align=center class=t1><font size=2 color=#000000><b>비 고</b></font></td>
		</tr>
		<tr width=100%>
		...
		<form method="post" name="f">
				<tr valign=top>
					...
					<td width=120 align=center class=t1 style="text-overflow:ellipsis;"><font size=2 color=#000000><input
							type="hidden" name="pdetail" readonly
							value="<%=productList.get(i).getP_detail()%>"/><b><%=productList.get(i).getP_detail()%></b></font></td>
					<td width=120 align=center class=t1 style="text-overflow:ellipsis;"><font size=2 color=#000000><input
							type="hidden" name="ptypeno" readonly
					...
					<td align=center class=t1><input type=submit value="수정" onclick="javascript: form.action='admin_product_modify_form.jsp';" />
